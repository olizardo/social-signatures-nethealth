...
\section{The Social Signatures Framework: Lineage, Advances, and Open Frontiers}
...
\subsection{Foundational Origins: Cognitive Constraints and Persistent Skewness}
...
\subsection{The Multichannel and Multimodal Frontier: Cross-Platform Consistency}

Following Saram{\"a}ki and colleagues' initial findings, a major research thrust examined whether social signatures are idiosyncratic to traditional voice telephony or reflect a universal organizing principle across modern communication channels. 
...
\subsection{Theoretical Formalisms and Universal Scaling Dynamics}
...
Simultaneously, \citet{iniguez2023universal} tackled the generative micro-foundations of tie strength heterogeneity. Analyzing personal networks across millions of individuals in four massive datasets (mobile calls, text messages, Twitter mentions, and Wikipedia talk pages), they showed universality in the distributions of tie strengths and their individual-level variations. To explain this universality, \citet{iniguez2023universal} introduced a microscopic model of egocentric network evolution driven by a dynamic competition between two fundamental behavioral mechanisms:
\begin{enumerate}
...
\subsection{Methodological Refinements: Disentangling Network Size from Tie Strength Heterogeneity}
...
\subsection{Longitudinal Drift, Biometric Uniqueness, and Privacy}
...
\subsection{Critical Open Questions and Frontiers Addressed by the NetHealth Study}
